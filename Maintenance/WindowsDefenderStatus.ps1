...
#Check if the operating System is 2016 or newer
$OperatingSystem = (Systeminfo | Select-String 'Betriebssystemname:')
$OperatingSystem = $OperatingSystem.ToString().Split(':')[1].Trim()

if($OperatingSystem -notmatch "2012"){
    ...
    Write-Host -ForegroundColor Yellow "Das Skritp muss auf einem Host mit dem Betriebssystem Windows Server 2016 oder neuer ausgeführt werden."
}